webpackJsonp([11], {
          ...
          return (
            ...
            (i.onSubmit = function(e) {
              return Object(p.a)(e).then(function() {
                setTimeout(function() {
                  i.props.history.replace('/packages');
                }, 1e3);
              });
            }),
            (u = n),
                ...
                return a.a.createElement(
                  ...
                  a.a.createElement(
                    ...
                    a.a.createElement(
                      s.e,
                      null,
                      a.a.createElement(l.a, {onSubmit: this.onSubmit})
                    )
                  )
                );
              },
  ...
  239: function(e, t, n) {
            ...
            },
            {
              ...
              value: function() {
                ...
                if (this.hasOptions())
                  ...
                  var V = D({inputValue: v});
                  if (null === V) return null;
                  _ = A.a.createElement(s, c, V);
                }
    ...
    var Dt = function() {
          ...
          (this.selectOption = function(t) {
            ...
            if (n.isMulti) {
              ...
              if (e.isOptionSelected(t, r)) {
                ...
                e.setValue([].concat(W(r), [t]), 'select-option', t),
                  e.announceAriaLiveSelection({
                    event: 'select-option',
                    context: {value: e.getOptionLabel(t)},
                  });
                  ...
                  value: function(e) {
                    if ('function' === typeof this.props[e]) {
                      for (
                        ...
                        o[r - 1] = arguments[r];
                      return (t = this.props)[e].apply(t, W(o));
                    }
                  },
                },
                {
      ...
      Vt = B({allowCreateWhileLoading: !1, createOptionPosition: 'last'}, It),
      Lt = function(e) {
        var t, n;
        return (
          (n = t = (function(t) {
      ...
      Ut = function(e) {
        return function(t) {
          return A.a.createElement(Tt, B({component: e}, t));
        };
      },
      zt = function(e) {
        return function(t) {
          return A.a.createElement(V.TransitionGroup, B({component: e}, t));
        };
      },
      Wt = function(e) {
    ...
    var o = function e(t) {
      function n(e, t, r, l, c) {
        for (
          ...
          if (
            ...
            switch (h) {
              case 123:
                for (
                  U = U.trim(), p = U.charCodeAt(0), m = 1, B = ++V;
                  V < N;

                ) {
                  switch ((h = r.charCodeAt(V))) {
                    case 123:
                      m++;
                      break;
                    case 125:
              ...
              case 59:
                if (
                  ...
                  switch (
                    ...
                    0 < L &&
                      void 0 !== (g = s(1, U, t, e, k, M, z.length, l, c, l)) &&
                      0 === (B = (U = g.trim()).length) &&
                      (U = '\0\0'),
                    (p = U.charCodeAt(0)),
                    (h = U.charCodeAt(1)),
                    ...
                    default:
                      58 !== U.charCodeAt(B - 1) &&
                        (z += i(U, p, h, U.charCodeAt(2)));
                  }
                (R = T = D = p = 0), (U = ''), (h = r.charCodeAt(++V));
            }
          }
          switch (h) {
            case 13:
            case 10:
              47 === C
                ...
                : 0 === 1 + p &&
                  ...
                  0 < U.length &&
                  ((T = 1), (U += '\0')),
                0 < L * j && s(0, U, t, e, k, M, z.length, l, c, l),
                (M = 1),
                k++;
              break;
            case 59:
        ...
        if (0 < (B = z.length)) {
          if (
            ((T = t),
            0 < L &&
              void 0 !== (g = s(2, z, T, e, k, M, B, l, c, l)) &&
              0 === (z = g).length)
          )
            return G + z + W;
          if (((z = T.join(',') + '{' + z + '}'), 0 !== _ * P)) {
            switch ((2 !== _ || u(z, 2) || (P = 0), P)) {
              case 111:
      ...
      function s(e, t, n, o, r, i, u, a, s, l) {
        for (var c, f = 0, d = t; f < L; ++f)
          switch ((c = V[f].call(p, e, d, n, o, r, i, u, a, s, l))) {
            case void 0:
            case !1:
            case !0:
            case null:
      ...
      function p(t, o) {
        ...
        var r = t;
        if (
          (33 > r.charCodeAt(0) && (r = r.trim()), (R = r), (r = [R]), 0 < L)
        ) {
          var i = s(-1, o, r, r, k, M, 0, 0, 0, 0);
          void 0 !== i && 'string' === typeof i && (o = i);
        }
        var u = n(I, r, o, 0, 0);
        return (
          0 < L &&
            void 0 !== (i = s(-2, u, r, r, k, M, u.length, 0, 0, 0)) &&
            (u = i),
          (R = ''),
          (P = 0),
          (M = k = 1),
...
//# sourceMappingURL=11.b8562cc3.chunk.js.map
